...
### Solucion 1
```Scala
val data = List((72,110), (76,120), (78,125),
  (81,130), (89,135), (95,140), (108,160),
  (115,170), (120,175),(130,180))
...
```Scala
//Segundo Ejercicio
def add20(lists: List[List[Int]]):
List[List[Int]] = { lists.map(innerList=>innerList.map(element => element+20)) }

// Prueba de la función
val resultado = add20(List(List(1), List(2, 3)))
println(resultado)
// Salida esperada: List(List(21), List(22, 23))
```
